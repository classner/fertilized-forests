...
REM echo Zipping.
REM "C:\Program Files\7-Zip\7z" a fertilized-package.zip bin CodeGenerator documentation external fertilized fertilized_tests include lib matfertilized Presentation pyfertilized SConsChecks fertilized.sln license.txt README.MD SConscript.py SConstruct version.py
