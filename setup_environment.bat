...
echo It is a guided walkthrough through the requirement installations and setup options. It will (but only with your permission) install required software and create two files on success:
