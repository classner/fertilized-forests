...
echo Zipping.
"C:\Program Files\7-Zip\7z" a fertilized-package.zip .git bin CodeGenerator deployment documentation external fertilized fertilized_tests IDEs include lib matfertilized Presentation pyfertilized SConsChecks site_scons license.txt README.MD SConscript.py SConstruct setup_paths.bat compile.bat setup_environment.bat setup_environment_windows.py version.py
