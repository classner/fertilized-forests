 ...
 */
#include <cstddef>
#include "fertilized/ndarray/ArrayBase.h"
...
public:
    ...
    Element & operator()(std::size_t n0) const {
...
public:
    ...
    Element & operator()(std::size_t n0, std::size_t n1) const {
...
public:
    ...
    Element & operator()(std::size_t n0, std::size_t n1, std::size_t n2) const {
...
public:
    ...
    Element & operator()(std::size_t n0, std::size_t n1, std::size_t n2, std::size_t n3) const {
...
public:
    ...
    Element & operator()(std::size_t n0, std::size_t n1, std::size_t n2, std::size_t n3, std::size_t n4) const {
...
public:
    ...
    Element & operator()(std::size_t n0, std::size_t n1, std::size_t n2, std::size_t n3, std::size_t n4, std::size_t n5) const {
