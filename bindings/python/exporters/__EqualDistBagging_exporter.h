...
#pragma once
#ifndef PYFERTILIZED_EXPORTERS___EQUALDISTBAGGING_EXPORTER_H_
#define PYFERTILIZED_EXPORTERS___EQUALDISTBAGGING_EXPORTER_H_
...
namespace pyfertilized {
  ...
  void export_EqualDistBagging(const std::string &type_short) {
    // Explicit function pointers and overloads.
    bool (fertilized::EqualDistBagging<input_dtype,feature_dtype,annotation_dtype,leaf_return_dtype,forest_return_dtype>::*ptr_EqualDistBagging_0)
    (

        const fertilized::IBaggingStrategy<input_dtype, feature_dtype, annotation_dtype, leaf_return_dtype, forest_return_dtype> &
) const =
      &fertilized::EqualDistBagging<input_dtype,feature_dtype,annotation_dtype,leaf_return_dtype,forest_return_dtype>::operator==;
    bool (*ptr_EqualDistBagging_1)
    (
...
,
    ...
    py::class_<EqualDistBagging<input_dtype,feature_dtype,annotation_dtype,leaf_return_dtype,forest_return_dtype>,
               std::shared_ptr<EqualDistBagging<input_dtype,feature_dtype,annotation_dtype,leaf_return_dtype,forest_return_dtype>>,
               boost::noncopyable,
               py::bases<IBaggingStrategy <input_dtype, feature_dtype, annotation_dtype, leaf_return_dtype, forest_return_dtype> >>
               (("EqualDistBagging" + type_short).c_str(),
...
",
                 py::init<
                         ...
                         >())
#ifdef SERIALIZATION_ENABLED
    .def_pickle(ParameterlessPickleSuite<EqualDistBagging<input_dtype,feature_dtype,annotation_dtype,leaf_return_dtype,forest_return_dtype>>())
#endif
    .def("__eq__", ptr_EqualDistBagging_0, "-----\n\
\n\
Available in:\n\
\n\
- C++\n\
...
-----\n\
")
    .def("__ne__", ptr_EqualDistBagging_1, "")
    ;

    py::implicitly_convertible<std::shared_ptr<EqualDistBagging<input_dtype,feature_dtype,annotation_dtype,leaf_return_dtype,forest_return_dtype>>,
                               std::shared_ptr<IBaggingStrategy <input_dtype, feature_dtype, annotation_dtype, leaf_return_dtype, forest_return_dtype> > >();
  };
}  // namespace fertilized

#endif  // PYFERTILIZED_EXPORTERS___EQUALDISTBAGGING_EXPORTER_H_