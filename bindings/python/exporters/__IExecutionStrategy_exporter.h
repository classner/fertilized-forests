...
#pragma once
#ifndef PYFERTILIZED_EXPORTERS___IEXECUTIONSTRATEGY_EXPORTER_H_
#define PYFERTILIZED_EXPORTERS___IEXECUTIONSTRATEGY_EXPORTER_H_
...
namespace pyfertilized {
  ...
  void export_IExecutionStrategy(const std::string &type_short) {
    // Explicit function pointers and overloads.
    py::class_<IExecutionStrategy<input_dtype,feature_dtype,annotation_dtype,leaf_return_dtype,forest_return_dtype>,
               boost::noncopyable>
               (("IExecutionStrategy" + type_short).c_str(),
                "Specifies a way of executing TrainingAction s.\n\
\n\
\n\
-----\n\
\n\
...
#endif  // PYFERTILIZED_EXPORTERS___IEXECUTIONSTRATEGY_EXPORTER_H_