...
using namespace fertilized;
  ...
  // From C types conversions.
    ...
    auto __converted_decider = *reinterpret_cast<std::shared_ptr<fertilized::Tree<uint8_t, int16_t, int16_t, std::pair<float, std::shared_ptr<std::vector<int16_t>>>, std::vector<std::pair<float, std::shared_ptr<std::vector<int16_t>>>>>::dec_t>*>(decider);
              

    auto __converted_leaf_manager = *reinterpret_cast<std::shared_ptr<fertilized::Tree<uint8_t, int16_t, int16_t, std::pair<float, std::shared_ptr<std::vector<int16_t>>>, std::vector<std::pair<float, std::shared_ptr<std::vector<int16_t>>>>>::leaf_man_t>*>(leaf_manager);
              

#pragma warning( push )
#pragma warning( disable : 4800 )
  // Get the libraries' result.
  auto *libfunc_result = new std::shared_ptr<Tree<uint8_t,int16_t,int16_t,std::pair<float, std::shared_ptr<std::vector<int16_t>>>,std::vector<std::pair<float, std::shared_ptr<std::vector<int16_t>>>>>>(
    new Tree<
              uint8_t,
              int16_t,
              int16_t,
...
#pragma warning( pop )
  ...
  // Unpack instance.
  auto __instance_unpacked = *static_cast<std::shared_ptr<Tree<uint8_t,int16_t,int16_t,std::pair<float, std::shared_ptr<std::vector<int16_t>>>,std::vector<std::pair<float, std::shared_ptr<std::vector<int16_t>>>>>>*>(__instance);
  // From C types conversions.

    auto __shptr_data_provider = *reinterpret_cast<std::shared_ptr<fertilized::Tree<uint8_t,int16_t,int16_t,std::pair<float, std::shared_ptr<std::vector<int16_t>>>,std::vector<std::pair<float, std::shared_ptr<std::vector<int16_t>>>>>::dprov_t>*>(data_provider);
...
#pragma warning( pop )
  ...
  // From C types conversions.
    ...
    auto __shptr_rhs = *reinterpret_cast<std::shared_ptr<fertilized::Tree<uint8_t,int16_t,int16_t,std::pair<float, std::shared_ptr<std::vector<int16_t>>>,std::vector<std::pair<float, std::shared_ptr<std::vector<int16_t>>>>>::tree_t>*>(rhs);
...
void delete_Tree_uint8_int16_int16_hp_vhp(void *ptr) {
  auto * storage = static_cast<std::shared_ptr<Tree<uint8_t,int16_t,int16_t,std::pair<float, std::shared_ptr<std::vector<int16_t>>>,std::vector<std::pair<float, std::shared_ptr<std::vector<int16_t>>>>>>*>(ptr);
  delete storage;
}
