...
using namespace fertilized;
  ...
  // From C types conversions.
    ...
    auto __converted_feature_calculator = *reinterpret_cast<std::shared_ptr<fertilized::ThresholdDecider<double, double, uint>::feat_calc_t>*>(feature_calculator);
              

    auto __converted_threshold_optimizer = *reinterpret_cast<std::shared_ptr<fertilized::ThresholdDecider<double, double, uint>::thresh_opt_t>*>(threshold_optimizer);
              

#pragma warning( push )
#pragma warning( disable : 4800 )
  // Get the libraries' result.
  auto *libfunc_result = new std::shared_ptr<ThresholdDecider<double,double,uint>>(
...
#pragma warning( pop )
  ...
  // Unpack instance.
  auto __instance_unpacked = *static_cast<std::shared_ptr<ThresholdDecider<double,double,uint>>*>(__instance);
  // From C types conversions.
...
#pragma warning( pop )
  ...
  // From C types conversions.
    ...
    auto __shptr_rhs = *reinterpret_cast<std::shared_ptr<fertilized::IDecider<double, double, uint>>*>(rhs);
...
void delete_ThresholdDecider_d_d_uint(void *ptr) {
  auto * storage = static_cast<std::shared_ptr<ThresholdDecider<double,double,uint>>*>(ptr);
  delete storage;
}
