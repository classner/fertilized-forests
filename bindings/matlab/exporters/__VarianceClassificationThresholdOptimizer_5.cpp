...
#pragma warning( disable : 4800 )
  ...
  auto *libfunc_result = new std::shared_ptr<VarianceClassificationThresholdOptimizer<uint8_t,float,uint>>(
...
#pragma warning( pop )
  ...
  // Unpack instance.
  auto __instance_unpacked = *static_cast<std::shared_ptr<VarianceClassificationThresholdOptimizer<uint8_t,float,uint>>*>(__instance);
  // From C types conversions.
...
void delete_VarianceClassificationThresholdOptimizer_uint8_f_uint(void *ptr) {
  auto * storage = static_cast<std::shared_ptr<VarianceClassificationThresholdOptimizer<uint8_t,float,uint>>*>(ptr);
  delete storage;
}
