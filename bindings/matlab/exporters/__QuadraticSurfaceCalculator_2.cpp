...
#pragma warning( disable : 4800 )
  ...
  auto *libfunc_result = new std::shared_ptr<QuadraticSurfaceCalculator<float,uint>>(
...
#pragma warning( pop )
  ...
  // Unpack instance.
  auto __instance_unpacked = *static_cast<std::shared_ptr<QuadraticSurfaceCalculator<float,uint>>*>(__instance);
  // From C types conversions.
...
void delete_QuadraticSurfaceCalculator_f_uint(void *ptr) {
  auto * storage = static_cast<std::shared_ptr<QuadraticSurfaceCalculator<float,uint>>*>(ptr);
  delete storage;
}
