...
#pragma warning( disable : 4800 )
  ...
  auto *libfunc_result = new std::shared_ptr<NoCopyPatchSampleManager<uint8_t,int16_t>>(
...
void delete_NoCopyPatchSampleManager_uint8_int16(void *ptr) {
  auto * storage = static_cast<std::shared_ptr<NoCopyPatchSampleManager<uint8_t,int16_t>>*>(ptr);
  delete storage;
}
