...
using namespace fertilized;
  ...
  // From C types conversions.
    ...
    std::vector<std::shared_ptr<typename fertilized::Forest<uint8_t, int16_t, int16_t, std::pair<float, std::shared_ptr<std::vector<int16_t>>>, std::vector<std::pair<float, std::shared_ptr<std::vector<int16_t>>>>>::dec_t>> __converted_deciders;
    {
      std::vector<void*> carryvec = *reinterpret_cast<std::vector<void*>*>(deciders);
      __converted_deciders = recover_vec_types<std::shared_ptr<typename fertilized::Forest<uint8_t, int16_t, int16_t, std::pair<float, std::shared_ptr<std::vector<int16_t>>>, std::vector<std::pair<float, std::shared_ptr<std::vector<int16_t>>>>>::dec_t>>(carryvec);
    }
              

    std::vector<std::shared_ptr<typename fertilized::Forest<uint8_t, int16_t, int16_t, std::pair<float, std::shared_ptr<std::vector<int16_t>>>, std::vector<std::pair<float, std::shared_ptr<std::vector<int16_t>>>>>::leaf_man_t>> __converted_leaf_managers;
    {
      std::vector<void*> carryvec = *reinterpret_cast<std::vector<void*>*>(leaf_managers);
      __converted_leaf_managers = recover_vec_types<std::shared_ptr<typename fertilized::Forest<uint8_t, int16_t, int16_t, std::pair<float, std::shared_ptr<std::vector<int16_t>>>, std::vector<std::pair<float, std::shared_ptr<std::vector<int16_t>>>>>::leaf_man_t>>(carryvec);
    }
              

    auto __converted_training = *reinterpret_cast<std::shared_ptr<fertilized::Forest<uint8_t, int16_t, int16_t, std::pair<float, std::shared_ptr<std::vector<int16_t>>>, std::vector<std::pair<float, std::shared_ptr<std::vector<int16_t>>>>>::training_t>*>(training);
              

#pragma warning( push )
#pragma warning( disable : 4800 )
  // Get the libraries' result.
  auto *libfunc_result = new std::shared_ptr<Forest<uint8_t,int16_t,int16_t,std::pair<float, std::shared_ptr<std::vector<int16_t>>>,std::vector<std::pair<float, std::shared_ptr<std::vector<int16_t>>>>>>(
    new Forest<
              uint8_t,
              int16_t,
              int16_t,
...
#pragma warning( pop )
  ...
  // From C types conversions.
    ...
    std::vector<fertilized::Forest<uint8_t, int16_t, int16_t, std::pair<float, std::shared_ptr<std::vector<int16_t>>>, std::vector<std::pair<float, std::shared_ptr<std::vector<int16_t>>>>>::tree_ptr_t> __converted_trees;
    {
      std::vector<void*> carryvec = *reinterpret_cast<std::vector<void*>*>(trees);
      __converted_trees = recover_vec_types<fertilized::Forest<uint8_t, int16_t, int16_t, std::pair<float, std::shared_ptr<std::vector<int16_t>>>, std::vector<std::pair<float, std::shared_ptr<std::vector<int16_t>>>>>::tree_ptr_t>(carryvec);
    }
...
#pragma warning( pop )
  ...
  // Unpack instance.
  auto __instance_unpacked = *static_cast<std::shared_ptr<Forest<uint8_t,int16_t,int16_t,std::pair<float, std::shared_ptr<std::vector<int16_t>>>,std::vector<std::pair<float, std::shared_ptr<std::vector<int16_t>>>>>>*>(__instance);
  // From C types conversions.
...
#pragma warning( pop )
  ...
  // From C types conversions.
    ...
    auto __converted_fdata_provider = *reinterpret_cast<std::shared_ptr<fertilized::Forest<uint8_t, int16_t, int16_t, std::pair<float, std::shared_ptr<std::vector<int16_t>>>, std::vector<std::pair<float, std::shared_ptr<std::vector<int16_t>>>>>::fdprov_t>*>(fdata_provider);
              

    auto __shptr_execution_strategy = *reinterpret_cast<std::shared_ptr<fertilized::Forest<uint8_t,int16_t,int16_t,std::pair<float, std::shared_ptr<std::vector<int16_t>>>,std::vector<std::pair<float, std::shared_ptr<std::vector<int16_t>>>>>::exec_strat_t>*>(execution_strategy);
...
#pragma warning( pop )
  ...
  // From C types conversions.
    ...
    auto __shptr_rhs = *reinterpret_cast<std::shared_ptr<fertilized::Forest<uint8_t, int16_t, int16_t, std::pair<float, std::shared_ptr<std::vector<int16_t>>>, std::vector<std::pair<float, std::shared_ptr<std::vector<int16_t>>>>>>*>(rhs);
...
void delete_Forest_uint8_int16_int16_hp_vhp(void *ptr) {
  auto * storage = static_cast<std::shared_ptr<Forest<uint8_t,int16_t,int16_t,std::pair<float, std::shared_ptr<std::vector<int16_t>>>,std::vector<std::pair<float, std::shared_ptr<std::vector<int16_t>>>>>>*>(ptr);
  delete storage;
}
