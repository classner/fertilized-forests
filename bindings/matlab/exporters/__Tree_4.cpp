...
using namespace fertilized;
  ...
  // From C types conversions.
    ...
    auto __converted_decider = *reinterpret_cast<std::shared_ptr<fertilized::Tree<uint8_t, int16_t, uint, std::vector<float>, std::vector<float>>::dec_t>*>(decider);
              

    auto __converted_leaf_manager = *reinterpret_cast<std::shared_ptr<fertilized::Tree<uint8_t, int16_t, uint, std::vector<float>, std::vector<float>>::leaf_man_t>*>(leaf_manager);
              

#pragma warning( push )
#pragma warning( disable : 4800 )
  // Get the libraries' result.
  auto *libfunc_result = new std::shared_ptr<Tree<uint8_t,int16_t,uint,std::vector<float>,std::vector<float>>>(
    new Tree<
              uint8_t,
              int16_t,
              uint,
...
#pragma warning( pop )
  ...
  // Unpack instance.
  auto __instance_unpacked = *static_cast<std::shared_ptr<Tree<uint8_t,int16_t,uint,std::vector<float>,std::vector<float>>>*>(__instance);
  // From C types conversions.

    auto __shptr_data_provider = *reinterpret_cast<std::shared_ptr<fertilized::Tree<uint8_t,int16_t,uint,std::vector<float>,std::vector<float>>::dprov_t>*>(data_provider);
...
#pragma warning( pop )
  ...
  // From C types conversions.
    ...
    auto __shptr_rhs = *reinterpret_cast<std::shared_ptr<fertilized::Tree<uint8_t,int16_t,uint,std::vector<float>,std::vector<float>>::tree_t>*>(rhs);
...
void delete_Tree_uint8_int16_uint_fv_fv(void *ptr) {
  auto * storage = static_cast<std::shared_ptr<Tree<uint8_t,int16_t,uint,std::vector<float>,std::vector<float>>>*>(ptr);
  delete storage;
}
