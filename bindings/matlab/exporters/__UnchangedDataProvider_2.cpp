...
#pragma warning( disable : 4800 )
  ...
  auto *libfunc_result = new std::shared_ptr<UnchangedDataProvider<uint8_t,uint>>(
...
void delete_UnchangedDataProvider_uint8_uint(void *ptr) {
  auto * storage = static_cast<std::shared_ptr<UnchangedDataProvider<uint8_t,uint>>*>(ptr);
  delete storage;
}
