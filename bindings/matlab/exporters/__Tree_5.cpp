...
#pragma warning( pop )
  ...
  // From C types conversions.
    ...
    auto __shptr_data_provider = *reinterpret_cast<std::shared_ptr<fertilized::Tree<uint8_t,int16_t,int16_t,std::vector<float>,std::vector<float>>::dprov_t>*>(data_provider);
...
#pragma warning( pop )
  ...
  // From C types conversions.
    ...
    auto __shptr_rhs = *reinterpret_cast<std::shared_ptr<fertilized::Tree<uint8_t,int16_t,int16_t,std::vector<float>,std::vector<float>>::tree_t>*>(rhs);
