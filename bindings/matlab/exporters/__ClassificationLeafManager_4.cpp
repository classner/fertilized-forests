...
#pragma warning( disable : 4800 )
  ...
  auto *libfunc_result = new std::shared_ptr<ClassificationLeafManager<uint8_t,int16_t>>(
...
#pragma warning( pop )
  ...
  // Unpack instance.
  auto __instance_unpacked = *static_cast<std::shared_ptr<ClassificationLeafManager<uint8_t,int16_t>>*>(__instance);
  // From C types conversions.
...
void delete_ClassificationLeafManager_uint8_int16(void *ptr) {
  auto * storage = static_cast<std::shared_ptr<ClassificationLeafManager<uint8_t,int16_t>>*>(ptr);
  delete storage;
}
