...
#include <../../include/fertilized/features/quadraticsurfacecalculator.h>
...
#pragma warning( disable : 4800 )
  ...
  auto *libfunc_result = new std::shared_ptr<QuadraticSurfaceCalculator<double,double>>(
...
#pragma warning( pop )
  ...
  // Unpack instance.
  auto __instance_unpacked = *static_cast<std::shared_ptr<QuadraticSurfaceCalculator<double,double>>*>(__instance);
  // From C types conversions.
...
void delete_QuadraticSurfaceCalculator_d_d(void *ptr) {
  auto * storage = static_cast<std::shared_ptr<QuadraticSurfaceCalculator<double,double>>*>(ptr);
  delete storage;
}
