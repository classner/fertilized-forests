...
using namespace fertilized;
  ...
  // From C types conversions.
    ...
    std::vector<std::shared_ptr<typename fertilized::Forest<uint8_t, uint8_t, uint, std::vector<float>, std::vector<float>>::dec_t>> __converted_deciders;
    {
      std::vector<void*> carryvec = *reinterpret_cast<std::vector<void*>*>(deciders);
      __converted_deciders = recover_vec_types<std::shared_ptr<typename fertilized::Forest<uint8_t, uint8_t, uint, std::vector<float>, std::vector<float>>::dec_t>>(carryvec);
    }
              

    std::vector<std::shared_ptr<typename fertilized::Forest<uint8_t, uint8_t, uint, std::vector<float>, std::vector<float>>::leaf_man_t>> __converted_leaf_managers;
    {
      std::vector<void*> carryvec = *reinterpret_cast<std::vector<void*>*>(leaf_managers);
      __converted_leaf_managers = recover_vec_types<std::shared_ptr<typename fertilized::Forest<uint8_t, uint8_t, uint, std::vector<float>, std::vector<float>>::leaf_man_t>>(carryvec);
    }
              

    auto __converted_training = *reinterpret_cast<std::shared_ptr<fertilized::Forest<uint8_t, uint8_t, uint, std::vector<float>, std::vector<float>>::training_t>*>(training);
              

#pragma warning( push )
#pragma warning( disable : 4800 )
  // Get the libraries' result.
  auto *libfunc_result = new std::shared_ptr<Forest<uint8_t,uint8_t,uint,std::vector<float>,std::vector<float>>>(
    new Forest<
              uint8_t,
              uint8_t,
              uint,
...
#pragma warning( pop )
  ...
  // From C types conversions.
    ...
    std::vector<fertilized::Forest<uint8_t, uint8_t, uint, std::vector<float>, std::vector<float>>::tree_ptr_t> __converted_trees;
    {
      std::vector<void*> carryvec = *reinterpret_cast<std::vector<void*>*>(trees);
      __converted_trees = recover_vec_types<fertilized::Forest<uint8_t, uint8_t, uint, std::vector<float>, std::vector<float>>::tree_ptr_t>(carryvec);
    }
...
#pragma warning( pop )
  ...
  // Unpack instance.
  auto __instance_unpacked = *static_cast<std::shared_ptr<Forest<uint8_t,uint8_t,uint,std::vector<float>,std::vector<float>>>*>(__instance);
  // From C types conversions.
...
#pragma warning( pop )
  ...
  // From C types conversions.
    ...
    auto __converted_fdata_provider = *reinterpret_cast<std::shared_ptr<fertilized::Forest<uint8_t, uint8_t, uint, std::vector<float>, std::vector<float>>::fdprov_t>*>(fdata_provider);
              

    auto __shptr_execution_strategy = *reinterpret_cast<std::shared_ptr<fertilized::Forest<uint8_t,uint8_t,uint,std::vector<float>,std::vector<float>>::exec_strat_t>*>(execution_strategy);
...
#pragma warning( pop )
  ...
  // From C types conversions.
    ...
    auto __shptr_rhs = *reinterpret_cast<std::shared_ptr<fertilized::Forest<uint8_t, uint8_t, uint, std::vector<float>, std::vector<float>>>*>(rhs);
...
void delete_Forest_uint8_uint8_uint_fv_fv(void *ptr) {
  auto * storage = static_cast<std::shared_ptr<Forest<uint8_t,uint8_t,uint,std::vector<float>,std::vector<float>>>*>(ptr);
  delete storage;
}
