...
#pragma warning( disable : 4800 )
  ...
  auto *libfunc_result = new std::shared_ptr<QuadraticSurfaceCalculator<float,float>>(
...
#pragma warning( pop )
  ...
  // Unpack instance.
  auto __instance_unpacked = *static_cast<std::shared_ptr<QuadraticSurfaceCalculator<float,float>>*>(__instance);
  // From C types conversions.
...
void delete_QuadraticSurfaceCalculator_f_f(void *ptr) {
  auto * storage = static_cast<std::shared_ptr<QuadraticSurfaceCalculator<float,float>>*>(ptr);
  delete storage;
}
