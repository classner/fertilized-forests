classdef DifferenceSurfaceCalculator < FertilizedObject
    ...
    methods (Access = {?Soil, ?DifferenceSurfaceCalculator})
        function this = DifferenceSurfaceCalculator(dataTypes, libName, ptr, functionFormat)
            position_list = [1,2,3];
            tmp = '';
            for i = position_list
            ...
            delFuncName = ['delete_DifferenceSurfaceCalculator' tmp];
    ...
    methods (Access = public)
        function [res] = eq(this, rhs) 
            ...
            getter = sprintf('%s%s%s', 'eq', 'DifferenceSurfaceCalculator', suffix);
