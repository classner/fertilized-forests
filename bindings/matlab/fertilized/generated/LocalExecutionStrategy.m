classdef LocalExecutionStrategy < FertilizedObject
    ...
    methods (Access = {?Soil, ?LocalExecutionStrategy})
        function this = LocalExecutionStrategy(dataTypes, libName, ptr, functionFormat)
            ...
            delFuncName = ['delete_LocalExecutionStrategy' tmp];
