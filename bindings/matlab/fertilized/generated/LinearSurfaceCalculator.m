classdef LinearSurfaceCalculator < FertilizedObject
    ...
    methods (Access = {?Soil, ?LinearSurfaceCalculator})
        function this = LinearSurfaceCalculator(dataTypes, libName, ptr, functionFormat)
            position_list = [1,3];
            tmp = '';
            for i = position_list
            ...
            delFuncName = ['delete_LinearSurfaceCalculator' tmp];
    ...
    methods (Access = public)
        function [res] = eq(this, rhs) 
            ...
            getter = sprintf('%s%s%s', 'eq', 'LinearSurfaceCalculator', suffix);
