classdef IExecutionStrategy < FertilizedObject
    ...
    methods (Access = {?Soil, ?IExecutionStrategy})
        function this = IExecutionStrategy(dataTypes, libName, ptr, functionFormat)
            ...
            delFuncName = ['delete_IExecutionStrategy' tmp];
