classdef AdaBoost < FertilizedObject
    ...
    methods (Access = {?Soil, ?AdaBoost})
        function this = AdaBoost(dataTypes, libName, ptr, functionFormat)
            ...
            delFuncName = ['delete_AdaBoost' tmp];
    ...
    methods (Access = public)
        function [res] = eq(this, rhs) 
            ...
            getter = sprintf('%s%s%s', 'eq', 'AdaBoost', suffix);
