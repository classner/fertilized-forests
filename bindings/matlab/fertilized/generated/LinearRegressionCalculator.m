classdef LinearRegressionCalculator < FertilizedObject
    ...
    methods (Access = {?Soil, ?LinearRegressionCalculator})
        function this = LinearRegressionCalculator(dataTypes, libName, ptr, functionFormat)
            position_list = [1];
            tmp = '';
            for i = position_list
            ...
            delFuncName = ['delete_LinearRegressionCalculator' tmp];
    ...
    methods (Access = public)
        function [res] = eq(this, rhs) 
            ...
            getter = sprintf('%s%s%s', 'eq', 'LinearRegressionCalculator', suffix);
