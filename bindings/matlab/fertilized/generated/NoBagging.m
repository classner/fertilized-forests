classdef NoBagging < FertilizedObject
    ...
    methods (Access = {?Soil, ?NoBagging})
        function this = NoBagging(dataTypes, libName, ptr, functionFormat)
            ...
            delFuncName = ['delete_NoBagging' tmp];
    ...
    methods (Access = public)
        function [res] = eq(this, rhs) 
            ...
            getter = sprintf('%s%s%s', 'eq', 'NoBagging', suffix);
