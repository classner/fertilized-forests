classdef ConstantRegressionCalculator < FertilizedObject
    ...
    methods (Access = {?Soil, ?ConstantRegressionCalculator})
        function this = ConstantRegressionCalculator(dataTypes, libName, ptr, functionFormat)
            position_list = [1];
            tmp = '';
            for i = position_list
            ...
            delFuncName = ['delete_ConstantRegressionCalculator' tmp];
    ...
    methods (Access = public)
        function [res] = eq(this, rhs) 
            ...
            getter = sprintf('%s%s%s', 'eq', 'ConstantRegressionCalculator', suffix);
