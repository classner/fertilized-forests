 ...
 */
#ifndef MATFERTILIZED_MATLAB_HEADERS_BOOSTING_H_
#define MATFERTILIZED_MATLAB_HEADERS_BOOSTING_H_
...
extern "C"
{
     ...
     void * getAdaBoost_i_i_uint_fv_fv (

);
     void * getAdaBoost_f_f_uint_fv_fv (

);
     void * getAdaBoost_d_d_uint_fv_fv (

);
     void * getAdaBoost_uint8_uint8_uint_fv_fv (

);
     void * getAdaBoost_uint8_int16_uint_fv_fv (

);
     void * getAdaBoost_uint8_int16_int16_fv_fv (

);


     int eqAdaBoost_i_i_uint_fv_fv (void *__instance,

        void * rhs
);
     int eqAdaBoost_f_f_uint_fv_fv (void *__instance,

        void * rhs
);
     int eqAdaBoost_d_d_uint_fv_fv (void *__instance,
     ...
     int eqAdaBoost_uint8_int16_uint_fv_fv (void *__instance,

        void * rhs
);
     int eqAdaBoost_uint8_int16_int16_fv_fv (void *__instance,

        void * rhs
);
     void delete_AdaBoost_i_i_uint_fv_fv(void *ptr);
     void delete_AdaBoost_f_f_uint_fv_fv(void *ptr);
     void delete_AdaBoost_d_d_uint_fv_fv(void *ptr);
     void delete_AdaBoost_uint8_uint8_uint_fv_fv(void *ptr);
     void delete_AdaBoost_uint8_int16_uint_fv_fv(void *ptr);
     ...
     void * getSamme_uint8_int16_uint_fv_fv (

        float learning_rate
);
     void * getSamme_uint8_int16_int16_fv_fv (

        float learning_rate
);


     int eqSamme_i_i_uint_fv_fv (void *__instance,
     ...
     int eqSamme_d_d_uint_fv_fv (void *__instance,
     ...
     int eqSamme_uint8_int16_uint_fv_fv (void *__instance,

        void * rhs
);
     int eqSamme_uint8_int16_int16_fv_fv (void *__instance,

        void * rhs
);
     void delete_Samme_i_i_uint_fv_fv(void *ptr);
     void delete_Samme_f_f_uint_fv_fv(void *ptr);
     void delete_Samme_d_d_uint_fv_fv(void *ptr);
...
#endif //#ifndef MATFERTILIZED_MATLAB_HEADERS_BOOSTING_H_