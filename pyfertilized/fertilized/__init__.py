...
import pyfertilized as _pyfertilized
...
__all__ = ["Soil", "Result_Types", "_pyfertilized"]
...
class Soil:
  ...
  def StandardClassificationForest(self,
    ...
    if not hasattr(_pyfertilized, attrname):
      raise Exception("This function is not supported by the current Soil (pyfertilized.%s)!" % (attrname))
    exec_obj = _pyfertilized.__dict__[attrname]
    return exec_obj(
        n_classes,
        n_features,
        max_depth,
