...
with indent(4):
 ...
 print(os.listdir('nuget-deps'))
 print(os.listdir(r'nuget-deps\boost-compiled'))
 print(os.listdir(r'nuget-deps\boost-compiled\stage'))
 print(os.listdir(r'nuget-deps\boost-compiler\stage\libs'))
 print(os.path.abspath(r'nuget-deps\boost-compiler\stage\libs'))
