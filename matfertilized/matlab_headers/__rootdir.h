...
extern "C"
{
    ...
    DllExport void * getForest_d_d_uint_fv_fv (
    ...
    DllExport void * getForestFromTrees_d_d_uint_fv_fv (
    ...
    DllExport void * getCombineTrees_d_d_uint_fv_fv (
    ...
    DllExport void * getForestFromFile_d_d_uint_fv_fv (
    ...
    DllExport void fitForest_d_d_uint_fv_fv (void *__instance,
    ...
    DllExport void fit_dprovForest_d_d_uint_fv_fv (void *__instance,
    ...
    DllExport mxArray * predictForest_d_d_uint_fv_fv (void *__instance,
    ...
    DllExport mxArray * predict_imageForest_d_d_uint_fv_fv (void *__instance,
    ...
    DllExport size_t get_input_data_dimensionsForest_d_d_uint_fv_fv (void *__instance
    ...
    DllExport mxArray * get_tree_weightsForest_d_d_uint_fv_fv (void *__instance
    ...
    DllExport int eqForest_d_d_uint_fv_fv (void *__instance,
    ...
    DllExport void saveForest_d_d_uint_fv_fv (void *__instance,
    ...
    DllExport void * getTree_d_d_uint_fv_fv (
    ...
    DllExport void * getTreeFromFile_d_d_uint_fv_fv (
    ...
    DllExport void make_nodeTree_d_d_uint_fv_fv (void *__instance,
    ...
    DllExport void fitTree_d_d_uint_fv_fv (void *__instance,
    ...
    DllExport void fit_dprovTree_d_d_uint_fv_fv (void *__instance,
    ...
    DllExport mxArray * predictTree_d_d_uint_fv_fv (void *__instance,
    ...
    DllExport mxArray * predict_imageTree_d_d_uint_fv_fv (void *__instance,
    ...
    DllExport float get_weightTree_d_d_uint_fv_fv (void *__instance
    ...
    DllExport size_t get_n_nodesTree_d_d_uint_fv_fv (void *__instance
    ...
    DllExport void set_weightTree_d_d_uint_fv_fv (void *__instance,
    ...
    DllExport size_t get_input_data_dimensionsTree_d_d_uint_fv_fv (void *__instance
    ...
    DllExport size_t get_samples_storedTree_d_d_uint_fv_fv (void *__instance
    ...
    DllExport int eqTree_d_d_uint_fv_fv (void *__instance,
    ...
    DllExport void saveTree_d_d_uint_fv_fv (void *__instance,
    ...
    DllExport void delete_Tree_d_d_uint_fv_fv(void *ptr);
