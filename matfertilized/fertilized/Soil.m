...
classdef Soil
    ...
    properties (SetAccess = private)
        ...
        MainHeader = 'matlab.h';
        AdditionalHeaders = { 'objectvector.h', 'stringvector.h', '__bagging.h', '__data_providers.h', '__deciders.h', '__execution_strategies.h', '__features.h', '__gains.h', '__impurities.h', '__leafs.h', '__regression.h', '__rootdir.h', '__threshold_optimizers.h', '__trainings.h', '__functions_standard_forests.h', '__functions_standard_trees.h', '__functions_feature_extraction.h' };
        ...
        function this = Soil(input_dtype,...
            ...
            if ~libisloaded(this.LibName)
                ...
                for header = this.AdditionalHeaders
                    args = [args, 'addheader'];
                    args = [args, strcat(fileparts(mfilename('fullpath')), ...
                                                   filesep, ...
                                                   'headers', ...
                                                   filesep, ...
                                                   header)];
