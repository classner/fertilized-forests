...
It is a guided walkthrough through the requirement installations and setup options. It will install required software and create/customize two files on success:
